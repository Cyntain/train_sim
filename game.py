...
def main():
    ...
    resources = [GRASS, GRASS_BOT_RIGHT, GRASS_BOT_LEFT, GRASS_TOP_RIGHT, GRASS_TOP_LEFT, WATER, STATION]
    ...
    tilemap[random.randint(0,MAPHEIGHT)][random.randint(0,MAPWIDTH)] = STATION # create one station in the map
    ...
    while True:
        for event in pygame.event.get():   # get all user inputs
            ...
            # Mouse position 
                ...
                mousex = int(mousex/TILESIZE)
                mousey = int(mousey/TILESIZE)
                currentTile = tilemap[cursorPos[1]][cursorPos[0]]
                print(currentTile)
